...
namespace Correios.Demo
{
    public class CorreiosManager
    {
        ...
        private readonly string _usuario = "46503584000119";

        /// Obtenha o código aqui: https://cws.correios.com.br/dashboard/pesquisa
        private readonly string _codigoAcesso = "5cOie6MzmnxYHrbUVtwFDO2pzKkXFm1AIRbFQTPb";
        ...
        private readonly string _cartaoPostagem = "0078058856";
